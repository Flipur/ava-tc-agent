...
const LINES = [
  ...
  "CRITICAL: Every response MUST end with exactly one action block. The ONLY valid action types are: create_docusign, send_invoice, generate_bid, send_email, slack_message. Never invent new action types like get_deal_context or lookup_property. If you need to look up a deal just respond with a slack_message action.",
