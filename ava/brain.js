...
const LINES = [
  ...
  "BID RULE: When someone asks to create a bid, repair estimate, or inspection bid use the generate_bid action. If they provide a CompanyCam URL include it in the payload. Always ask the team for dollar estimates for each issue — show the list of issues first and say: Here are the issues I found. Please reply with your estimated cost for each one, or type skip to exclude it. Once you have all estimates show the full bid summary for approval before generating the PDF.",
